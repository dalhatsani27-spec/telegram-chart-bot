...
# SMC and OTE were removed (trendline-only engine). VALID_STRATEGIES stays
# permissive on both so a stale saved selection from before the removal
# doesn't crash set_selected_strategy() -- it just isn't reachable from
# any menu button anymore.
VALID_STRATEGIES = {STRATEGY_UNIFIED, STRATEGY_TRENDLINE}
