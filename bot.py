...
def get_pairs_keyboard(pairs, prefix, back_callback):
    kb, row = [[InlineKeyboardButton("🏠 Dashboard", callback_data="menu_home")]], []
    for pair in pairs:
